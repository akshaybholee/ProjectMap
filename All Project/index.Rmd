...
getdatasharepointlist <- function (con, listName = NULL, listID = NULL, expand = F)
{
 ...
 conn <- sp_connection("https://tradeeconomics.sharepoint.com/sites/Projects", Username = "analytics@tradeeconomics.com", Password = "An@lytic$",
...
hcmap(
  ...
  borderWidth = 0.5,
  color = "#e2e2e2"
) %>%  hc_legend(enabled = FALSE) %>% hc_colorAxis(minColor = "#D6F4FF", maxColor = "#0291da") %>%
