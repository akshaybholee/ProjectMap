...
hcmap(
  ...
  color = "#ffffff"
                 ...
                 title = list(text = "Number of Projects", style = list(color = "#ffffff"))) %>% 
  ...
  hc_tooltip(crosshairs = FALSE, shared = TRUE, headerFormat = "<b>{point.name}</b>") %>% hc_plotOptions(map = list(nullColor = "#e1e1e1"
                                                                                                                      # "#052026"
                                                                                                                    )) %>%
  hc_size(900,600)
