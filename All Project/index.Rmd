...
getdatasharepointlist <- function (con, listName = NULL, listID = NULL, expand = F)
{
 ...
 # conn <- sp_connection("https://tradeeconomics.sharepoint.com/sites/Projects", Username = "analytics@tradeeconomics.com", Password = "Pog48797",
...
CountryInfo <- read.csv("C:\\Users\\IEC\\Downloads\\Country List (1).csv")
...
elements <- read.csv("C:\\Users\\IEC\\Downloads\\Project List (1).csv")
Region <- read.csv("C:\\Users\\IEC\\Downloads\\Regions.csv")
